<template>
  <div>
    ...
    <ul>
      ...
      <li>
        <span class="input-story__prop">simpleAudit - Object</span>
        <p style="margin: 0;color: rgba(98,20,17,0.78);font-size: 0.9em">
          Dates for entities with mStorage.simpleAudit == true.<br>
          It displays in the right top corner. If you dont set this prop than block with dates will be not displayed.</p>
      ...
      <li>
        ...
        <p style="margin: 0;color: rgba(98,20,17,0.78);font-size: 0.9em">
          It used for formConstructor opening.
          <br>If you dont set this prop the formConstructor action will say that this form is AutoGenerated</p>
      ...
      <li>
        ...
        <p style="margin: 0;color: rgba(98,20,17,0.78);font-size: 0.9em">set true if you want to overwrite default actions</p>
      ...
      <li>
        ...
        <p style="margin: 0;color: rgba(98,20,17,0.78);font-size: 0.9em">while you send array with buttons it overwrites the default buttons</p>
