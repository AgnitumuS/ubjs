...
/**
 * @author pavel.mash
 * Navigation shortcuts localization to Georgian for CDN model
  ...
  let localizationConfig = {
    ...
    localization: [
      { keyValue: 'cdn_desktop',
        execParams: {
          caption: 'საერთო ლექსიკონო',
          description: 'საგნების, მისამართების, სხვა კლასიფიკატორების დირექტორიები'
        }
      }
    ]
  }
