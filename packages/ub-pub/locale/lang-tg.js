...
UB.i18nExtend({
  ...
  OpenIDHeader: 'Ворид шудан тавассути сервиси тасдиқкуни.',
  OpenidTip: 'Воридшавӣ тавассути сервиси берунӣ сурат мегирад. Пас аз пахши "воридшавӣ", маълумотро дар равзанаи дахлдор (тасдиқкуни) ворид намоед.',
  OpenIDConnect: 'OpenID',
  authOpenIDConnectFail: 'Маркази тасдиқ дархости тасдиқкуниро рад кард',
  ...
  LoadCertificatesFailsCASelect: 'Барои истифодаи калиди хусусӣ, шумо сертификати онро бояд дошта бошед. <br><br> Лутфан Маркази сертификатсиони-ро интихоб кунед, ки шумо калиди шахсии худро гирифтаед ва мо кӯшиш мекунем, ки ин сертификатро ба таври худкор (автоматӣ) зеркашӣ (бор) кунем',
  'Load': 'Бор кардан',
  'Cancel': 'Бекор кардан',
  'ByKeyFile': 'Файл',
  'Use proxy server': 'Пайвастшави ба воситаи сервери прокси',
  'Proxy host': 'Сервер',
  'Proxy port': 'Порт',
  'Authenticate on proxy': 'Санҷиш (тасдиқкуни) дар сервери прокси',
  'User name': 'Истифодабаранда',
  'Save password': 'Рамзро сабт кардан',
  'Save': 'Сабт кардан',
  'Select CA': 'Маркази сертификаткунони-ро интихоб кунед',
  'CA': 'Маркази сертификатсия',
  'Crypto library settings': 'Танзимоти китобхонаи рамзгузорӣ',
  'Select device': 'Дастгоҳро интихоб кунед.',
  ...
  SignatureVerificationResultObj: {
    _: 'Натиҷаи санҷиши имзо (ҳо)',
    valid: {
      yes: 'Имзои электронӣ бомуваффақият тафтиш карда шуд, пурра ва дуруст будани маълумот тасдиқ карда шуд.',
      no: 'Имзои электрони нодуруст аст!',
      warnings: {
        annotations: 'Ҳуҷҷат эзоҳ дорад',
        signatureNotCoversWholeDocument: 'Имзои электронӣ ҳуҷҷатро пурра дар бар намегирад'
      }
    },
    tspValid: {
      yes: 'Вақти имзо аз чаҳорчӯбаи боэътимоди имзо барои Таъминкунанда тасдиқ карда шуд',
      no: 'Вақти имзо бо мӯҳри вақти боэътимод тасдиқ карда нашуд'
    },
    ocspVerified: {
      yes: 'Шаҳодатномаи имзо дар вақти имзо эътибор дошт',
      no: 'Барои нигаҳдории дарозмуддат (натиҷаи санҷиши шаҳодатнома дар вақти имзо ба имзо дохил намешавад)'
    },
    hardwareKeyUsed: 'hardwareKeyUsed',
    signingTime: 'Вақти мондани имзо',
    signatureStatus: 'Ҳолати имзо',
    signatureAuthor: 'Имзокунанда',
    certificate: {
      _: 'Шаҳодатнома (Сертификат)',
      keyUsage: 'Таъйиноти калид',
      serial: 'Рақами бақайдгирӣ',
      validFrom: 'Оғози мӯҳлати эътибор',
      validTo: 'Анҷоми мӯҳлати эътибор',
      issuedBy: {
        _: 'Дода шуд аз тарафи',
        orgName: 'Ташкилот',
        fullName: 'Маркази сертификатсия',
        country: 'Кишвар',
        locality: 'Ҷойгиршавӣ',
        issuerID: 'Шиносномаи маркази сертификатсия',
        orgUnit: 'Шӯъба (зербунёд)'
      },
      subject: {
        _: 'Соҳиб',
        DRFO: 'Рақами мушаххаси инфиродӣ (РМИ)',
        fullName: 'Ном',
        country: 'Кишвар',
        locality: 'Ҷойгиршавӣ',
        eMail: 'E-Mail',
      ...
      organization: {
        _: 'Ташкилот (муассиса)',
        EDRPOU: 'Феҳристи ягонаи давлатии корхонаҳо ва ташкилотҳо',
        orgName: 'Ном',
        digitalStampName: 'Мӯҳри электронӣ',
        position: 'Вазифаи имзокунанда',
        orgUnit: 'Ташкилот (муассиса)'
      }
    }
  },
  ...
  licenseExceedText: 'Меъёрҳои литсензионии дархост зиёданд. Шумо метавонед маълумотро бинед, аммо аксар тағирот роҳ дода намешавад'
