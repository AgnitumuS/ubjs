...
ok(files.length === 5, `_autotest.zip must contains 4 files but got ${files.length}`)
...
// logFiles(uZipB64)
// assert.strictEqual(uZipB64.files.length, 3, 'base64 must contains 3 file')
...
// console.strictEqual(Buffer.compare(file1251, hello), 0, 'cp1251 file equality')
