...
module.exports = function(session){
    var
        ...
        localizationConfig = {
            ...
            localization: [
                // UBS_MESSAGE_TYPE
                {keyValue: 'UBA.passwordPolicy.maxDurationDays',  execParams: {name: 'Срок действия пароля', description: 'Период(кол-во дней), по завершению которого система потребует смены пароля'}},
