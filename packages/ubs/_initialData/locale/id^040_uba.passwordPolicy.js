...
/**
 * @author
 * Password policy localization to Indonesian for UBA model
...
module.exports = function (session) {
  let localizationConfig = {
    ...
    localization: [
      ...
      { keyValue: 'UBA.passwordPolicy.checkDictionary', execParams: { name: "Don't allow password from dictionary", description: 'Deny long passwords from dictionary' } },
