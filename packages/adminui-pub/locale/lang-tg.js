 ...
 */
UB.i18nExtend({
  doYouWantLogoutFromExternalServer: 'Оё шумо мехоҳед сессияро дар ин система ба анҷом расонед?',
  ...
  'Record locked by another user': 'Истифодабарандаи дигар вурудро қулф кардааст',
  ...
  less: 'Камтар',
  equal: 'Баробар',
  range: 'Доираи маълумот (Диапазон)',
  contains: 'Дарбар мегирад',
  startWith: 'Оғоз бо',
  notEqual: 'Баробар нест',
  notContains: 'Дар бар намегирад',
  attention: 'Огоҳ',
  ...
  quickAccessButtons: 'Тугмаҳои зуд дастрасшаванда',
