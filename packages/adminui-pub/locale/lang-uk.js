...
UB.i18nExtend({
    ...
    podtverditUdalenije: "Підтвердіть видалення",
    ...
    msgInvalidPlugin: 'Версія плагіна застаріла. Встановлено версію {0}, необхідно {1}. Автоматичне оновлення відбувається раз на 2 години.' +
        ' Для ручного запуску скористайтеся <a href="models/adminui/ub-extension/pluginUpdateInstruction_uk.html" target="_blank">інструкцією</a>. ' +
