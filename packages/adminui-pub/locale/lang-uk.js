...
UB.i18nExtend({
  ...
  gridOptimizeWidth: 'Автопідбір ширини',
  ...
  'Record locked by another user': 'Запис заблоковано іншим користувачем',
  ...
  doYouWantFillOtherAttr: 'Ви бажаєте заповнити інші атрибути для "{0}" в довіднику "{1}"?',
  ...
  closeInactive: 'Закрити неактивні',
  ...
  doRecognizeDocument: 'Розпізнається документ ...',
