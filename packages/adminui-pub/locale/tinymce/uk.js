tinymce.addI18n('uk', {
  ...
  Format: 'Формат',
  Align: 'Вирівнювання',
  'Border style': 'Стиль границі',
  'Select...': 'Обрати...',
  Solid: 'Суцільна лінія',
  Dotted: 'Лінія із точок',
  Dashed: 'Штрихова лінія',
  Double: 'Подвійна лінія',
  Groove: 'Вбудований контур',
  Ridge: 'Рельєфний контур',
  Inset: 'Вбудований вигляд',
  Outset: 'Рельєфний вигляд',
  Hidden: 'Прихована лінія',
  Link: 'Посилання',
  Preformatted: 'Попередньо відформатований текст'
})
