tinymce.addI18n('az', {
  ...
  'Split cell': 'Xanaların sayı',
  'Cell padding': 'Xanaların sahələri',
  'Cell spacing': 'Xanaların arasında məsafə',
  ...
  'H Align': 'H Düzləndir',
  Top: 'Yuxarı',
  'Header cell': 'Xananın başlığı',
  Column: 'Sütun',
  'Row group': 'Sətirin qrupu',
  Cell: 'Xana',
  Middle: 'Orta',
  'Cell type': 'Xananın tipi',
  ...
  Center: 'Mərkəz üzrə',
  'Merge cells': 'Xanaları birləştir',
