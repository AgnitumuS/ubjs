...
UB.i18nExtend({
  ...
  rowCounts: 'Записей',
  doNotGetLock: 'Запись заблокирована пользователем {0} {1} сек. тому назад. Все внесенные изменения нельзя будет сохранить. Попробуйте позже',
  persistLockInfo: 'Заблокировано {1}',
  softLockInfo: 'Заблокировано пользователем "{0}" в {1}',
  'Record locked by another user': 'Запись заблокирована другим пользователем',
...
// !!!
  ...
  doRecognizeDocument: 'Распознается дукумент ...',
