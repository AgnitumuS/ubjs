...
//    UB.logDebug('extjs: %s', Ext.getVersion('extjs').version);
//    UB.logDebug('tinyMCE: %s.%s', tinyMCE.majorVersion, tinyMCE.minorVersion);
//    UB.logDebug('CodeMirror: %s', CodeMirror.version);
