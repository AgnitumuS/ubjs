/**
 * UB.ux.form.field.ComboExtraButtons.js
 */
Ext.define('UB.ux.form.field.ComboExtraButtons', {
  ...
  onParentFocus: function (cmp) {
    ...
    let arr = parentCombo.bodyEl.getXY()
    arr[1] -= 20
    me.showAt(arr)
  },
  ...
  onParentValueChange: function () {
    let me = this
    let parentCombo = me.parentCombo
    let disabled = !parentCombo.getStore().getById(parentCombo.getValue())
    me.items.first().setDisabled(disabled)
  },
  onClick: function (e) {
    let me = this
    ...
    let item = me.getItemFromEvent(e)
