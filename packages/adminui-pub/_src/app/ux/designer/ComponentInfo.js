...
Ext.define('UB.ux.designer.ComponentInfo',{
    ...
    data: {
        ...
        layout: {
            ...
            configs: {
                type: { type : 'String' , values: ['absolute', 'accordion', 'anchor', 'auto', 'autocomponent' +
                     'border', 'box', 'card', 'checkboxgroup','container', 'column', 'fit', 'form', 'table', 'ux.center','hbox','vbox'] },
    ...
    getType: function(type){
        ...
        if (!result){
            ...
            //Ext.Error.raise('Type "' + type + '" not found' );
        }
        return result;
