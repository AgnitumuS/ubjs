...
Ext.define('UB.view.ToolbarMenuButton', {
    ...
    initComponent: function(){
        ...
        $App.on('desktopChanged', function(){
            var leftPanel, viewport = $App.getViewport();
    ...
    viewPortResize: function(owner, width, height, oldWidth, oldHeight, eOpts){
        var leftPanel = this.getLeftPanel(), isHidden;
        if (leftPanel){
