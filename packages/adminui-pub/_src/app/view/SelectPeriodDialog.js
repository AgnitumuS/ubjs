...
Ext.define('UB.view.SelectPeriodDialog', {
  ...
  getPeriod: function (config) {
    ...
    var initFromDate; var initToDate; var periodConfig

    var selectFunc

    var yearPanel; var yearFrom; var yearTo
    ...
    function getPeriod (oldType) {
      var result = null; var twoElement; var dateFromD; var dateToD
