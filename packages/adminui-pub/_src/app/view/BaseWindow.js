...
Ext.define('UB.view.BaseWindow', {
  ...
  initComponent: function () {
    const
      me = this
    const commandConfig = this.commandCode ? UB.core.UBLocalStorageManager.getItem(this.windowLocalStoreKey = UB.core.UBLocalStorageManager.getKeyUI(this.commandCode), true) : undefined
