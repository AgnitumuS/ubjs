...
fpc -Tlinux -Px86_64 -MDelphi -Scghi -Cg -O1 -g -gl -l -vewnhibq -Fi%EXTERNAL_LIBS_PATH%\Synopse -Fi%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fi%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fu%EXTERNAL_LIBS_PATH%\Synopse -Fu%EXTERNAL_LIBS_PATH%\synapse40\source\lib -Fu%LAZARUS_PATH%\lcl\units\x86_64-linux -Fu%LAZARUS_PATH%\components\lazutils\lib\x86_64-linux -Fu%LAZARUS_PATH%\packager\units\x86_64-linux -Fu%SRC_PATH% -FU%LIB_PATH%\linux -FE%BIN_PATH% -k-L%SHARED_LIBS_BASE%\fpc-linux -olibubmail.so -dLCL -dLCLgtk2 -dSM52 %SRC_PATH%\UBMail.dpr