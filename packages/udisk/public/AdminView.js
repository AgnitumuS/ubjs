/*globals saveAs, UDISK, UBNativeDocEdit, UBDomain*/
/**
...
Ext.define("UDISK.AdminView",{
    ...
    initComponent: function () {
        ...
        me.fileGrid = Ext.create("UB.view.EntityGridPanel",{ //Ext.grid.Panel
              ...
              columns: [
                ...
                {text: UB.i18n('size'),  dataIndex: 'fsize',
                ...
                {
                    text: UB.i18n('udiskUpdateDate'),  dataIndex: 'mi_modifyDate',
    ...
    doSearchInternal: function(treePath, textField){
        ...
        request = {
            entity: me.entityName, method: 'select',
            fieldList: me.fieldList,
            whereList: {
                temp: me.isTempWhere
                //,permUserWhere: me.permUserWhere
    ...
    reloadFolders: function(){
        ...
        return $App.connection.select({entity: me.entityName, method: (me.mode === 'admin') ? 'adminSelect': 'select',
