...
## [Unreleased]
### Added
 - *SECURITY* if roles or groups for user is changed such user will be logged out immediately
 - *SECURITY* if user certificate is removed or updated such user will be logged out immediately
