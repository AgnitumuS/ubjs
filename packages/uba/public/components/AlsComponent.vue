<template>
  <div id="AlsComponent">
    <el-select v-model="selectedEntity" filterable clearable :placeholder="entityCaption">
      <el-option v-for="entity in entityList"
                 :key="entity.code"
                 :label="entity.code"
                 :value="entity.code">
      </el-option>
    ...
    <el-select v-model="selectedState"
      ...
      <el-option v-for="entity in stateList"
                 :key="entity"
                 :label="entity"
                 :value="entity">
      </el-option>
    ...
    <el-popover placement="bottom-end"
      ...
      <el-table :data="emptyAttributes"
                @row-click="onEmptyAttributesClick"
                :show-header="false">
        <el-table-column width="200" property="name">
        </el-table-column>
      </el-table>
      <el-button slot="reference"
                 v-if="selectedState && this.emptyAttributes.length !== 0"
                 icon="el-icon-plus"
    ...
    <el-button type="success"
               ...
               icon="el-icon-check"
               @click="save"
               :disabled="!needSave">{{saveCaption}}
    </el-button>
    <el-button type="success"
               v-if="selectedState"
               icon="el-icon-document"
               @click="generateDiffFile"
               :disabled="!needSave">{{generateDiffFileCaption}}
    </el-button>
    <el-row v-if="selectedState">
      <el-col :span="18">
        <el-table :data="[...usedAttributes].sort()"
                  width="100">
          <el-table-column
          ...
          <el-table-column v-for="role in checkedRoles"
                           :key="role"
                           header-align="center">
            <template slot-scope="scope">
              <action-component class="als__actions"
...
<script>
  const actionComponent = require('./RoleActionsComponent.vue')
