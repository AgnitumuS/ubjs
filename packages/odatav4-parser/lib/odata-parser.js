          ...
          if (result0 === null) {
            ...
            if (result0 === null) {
              ...
              if (result0 === null) {
                ...
                if (result0 === null) {
                  if (input.substr(pos, 12) === "not contains") {
                    result0 = "not contains";
                    pos += 12;
                  } else {
                    result0 = null;
                    if (reportFailures === 0) {
                      matchFailed("\"not contains\"");
                    }
                  }
                  if (result0 === null) {
                    if (input.substr(pos, 14) === "not startswith") {
                      result0 = "not startswith";
                      pos += 14;
                    } else {
                      result0 = null;
                      if (reportFailures === 0) {
                        matchFailed("\"not startswith\"");
                      }
                    }
                  }
                }
