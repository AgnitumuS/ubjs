...
//MPV dateTime                    =   "datetime" SQUOTE a:dateTimeBody SQUOTE { return new Date(a); }
dateTime                    =   a:dateTimeBody { return new Date(a); }

//MPV dateTimeOffset              =   "datetimeoffset" SQUOTE dateTimeOffsetBody SQUOTE
dateTimeOffset              =   dateTimeOffsetBody
...
booleanFunctions2Args       = "substringof" / "endswith" / "startswith" / "IsOf" / "contains" / "not contains" / "not startswith"
