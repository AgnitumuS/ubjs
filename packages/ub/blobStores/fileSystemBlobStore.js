 ...
 * @singleton
 */
const FileSystemBlobStore = Object.create(BlobStoreCustom)
 ...
 */
FileSystemBlobStore.getPermanentFileName = function (item) {
 ...
 * @return {Boolean}
 */
FileSystemBlobStore.fillResponse = function (requestParams, blobInfo, req, resp) {
 ...
 */
FileSystemBlobStore.saveContentToTempStore = function (request, attribute, content, req, resp) {
 ...
 */
FileSystemBlobStore.getContent = function (request, blobInfo, options) {
 ...
 */
FileSystemBlobStore.doCommit = function (attribute, ID, dirtyItem, oldItem) {
