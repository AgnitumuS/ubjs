  ...
  <div>
    ...
    >
      <button
        slot="preview"
        slot-scope="{row}"
        class="u-file-collection__action-icon u u-icon-eye"
      ...
      <button
        slot="download"
        slot-scope="{row}"
        class="u-file-collection__action-icon u u-icon-download"
      ...
      <button
        slot="remove"
        slot-scope="{row}"
        class="u-file-collection__action-icon u u-icon-delete"
        @click="remove(row.id)"
      />
