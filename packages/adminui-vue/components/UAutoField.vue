...
export default {
  ...
  render (h) {
    ...
    switch (this.dataType) {
      case 'Boolean':
        if (this.forceCmp === 'el-switch' && !baseAttrs.disabled && baseAttrs.readonly) {
          baseAttrs.disabled = baseAttrs.readonly // need because 'el-switch' doesn't have 'readonly' prop
        }
