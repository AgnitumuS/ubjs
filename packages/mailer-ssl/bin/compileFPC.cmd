...
fpc -Twin64 -Px86_64 -MDelphi -Scghi -WR %OPT% -Fi%EXTERNAL_LIBS_PATH%\Synopse -Fi%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fi%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fu%EXTERNAL_LIBS_PATH%\Synopse -Fu%EXTERNAL_LIBS_PATH%\synapse40\source\lib -Fu%LAZARUS_PATH%\lcl\units\x86_64-win64\win32 -Fu%LAZARUS_PATH%\lcl\units\x86_64-win64 -Fu%LAZARUS_PATH%\components\lazutils\lib\x86_64-win64 -Fu%LAZARUS_PATH%\packager\units\x86_64-win64 -Fu%SRC_PATH% -FU%LIB_PATH%\win64 -FE%BIN_PATH% -oubmail.dll -Fl%OPATH% -dLCL -dLCLwin32 -dSM52 -dopenssl %SRC_PATH%\UBMail.dpr
@if errorlevel 1 goto err
fpc -Tlinux -Px86_64 -MDelphi -Scghi -Cg %OPT% -FL%LAZARUS_PATH%\..\cross\lib\x86_64-linux\ld-linux-x86-64.so.2 -Fi%EXTERNAL_LIBS_PATH%\Synopse -Fi%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fi%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SyNode -Fu%EXTERNAL_LIBS_PATH%\Synopse\SQLite3 -Fu%EXTERNAL_LIBS_PATH%\Synopse -Fu%EXTERNAL_LIBS_PATH%\synapse40\source\lib -Fu%LAZARUS_PATH%\lcl\units\x86_64-linux -Fu%LAZARUS_PATH%\components\lazutils\lib\x86_64-linux -Fu%LAZARUS_PATH%\packager\units\x86_64-linux -Fu%SRC_PATH% -FU%LIB_PATH%\linux -FE%BIN_PATH% -k-L%SHARED_LIBS_BASE%\fpc-linux -olibubmail.so -dLCL -dLCLgtk2 -dSM52 -dopenssl %SRC_PATH%\UBMail.dpr
:err