...
См. [документацию и примеры использования](http://docs.ub.softline.kiev.ua/docs/WebClient/index.html#!/api/UB.view.FullTextSearchWidget)
...
См. дополнительно [документацию по конфигурированию автофильтра](http://docs.ub.softline.kiev.ua/docs/WebClient/index.html#!/api/UB.ux.UBPreFilter)
