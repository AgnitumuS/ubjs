...
test('Desktop test', async t => {
  const loginWin = await extSelector('.ub-login-window')
  ...
  const mainMenu = await extSelector('.ub-header-menu-item')
